...
{
    public partial class ByteSimulator : Form
    {
        double Mean;
        double Width;
        bool Print=false;
  
        public ByteSimulator()
        {
            InitializeComponent();
        ...
        public void SimulatedBytes()
        {
            ...
            if (Print)
            {
                ...
                {
                    output[k] = Convert.ToByte(GetPoisson(Mean));
                    Console.WriteLine("The {0}th element is {1}", k, output[k]);
                }
            }
        ...
        private void MeanSlider(object sender, EventArgs e)
        {
            Mean = trackBar1.Value;

        }

        private void WidthSlider(object sender, EventArgs e)
        {
